...
public class Soru1_AtmSorusu {
    ...
    private static void giris() {
        ...
        if (kKartNo.equals(kartNo) && kSifre.equals(sifre)) { // kKartNo==kartNo---> BU ŞeKİLDE STRİNG İFADELERİ
            // KARŞILAŞTIRMAK İSTERSEK, BU İFADELERİN
            //REFERANS DEĞERLERİNİ KARŞILAŞTIRMIŞ OLURUZ..
            menu();
        }else {
            System.out.println("HATALI GİRİŞ YAPTINIZ...");
            scan.nextLine();// DUMMY ==> daha onceden olusturulan scan objesinde ki nextLine methodunu cagiriyoruz.
                                // Araya bir bosluk atmak icin
            giris();
        }
    }
    ...
    private static void menu() {
        ...
        switch (secim) {
            ...
            case 2: {
                ...
                //paraYatirma(miktar); BU iki satir asagidaki tek satir ile ayni isi yapiyor.
    ...
    static void paraGonderme() {
        ...
        scan.nextLine(); //dummy metodu(kukla) _ Iban numarasi istemeden hatali giris yaptiniz sinyali
        // verdigi icin araya bir bosluk attik(dummy degiskeni ile)
